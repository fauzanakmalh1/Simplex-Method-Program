...
var theInstructionString = "Petunjuk: " + cr + " (1) Variable harus diawali dengan huruf." + cr + tab + tab + "    (contoh : a, x1, var, etc) " + cr + " (2) Untuk input pecahan, variabel berada disebelah kanan konstanta." + cr + tab + tab + "    (Contoh : (1/3)x bukan x/3) " + cr + " (3) Setiap variabel yang digunakan harus muncul pada fungsi  " + cr + tab + tab + "    (Contoh p = 0x + 2y + 0z ) " + cr + " (4) Gunakan keyword 'maximize' atau 'minimize') and 'subject to' " + cr + " (5) Setiap pertidak samaan harus ditulis dibaris masing-masing, seperti contoh. " + cr + " (6) Tidak perlu menginput data konstanta default: x >= 0, y >= 0, z >= 0 etc."
...
// alert("tableau is set up");
	...
	// 
		...
		document.theSpreadsheet.expr.value = "Tekan 'Hasil' untuk mencari solusi.";
